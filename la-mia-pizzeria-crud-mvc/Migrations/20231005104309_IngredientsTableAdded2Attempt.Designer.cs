...
namespace la_mia_pizzeria_crud_mvc.Migrations
{
    ...
    [Migration("20231005104309_IngredientsTableAdded2Attempt")]
    partial class IngredientsTableAdded2Attempt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("la_mia_pizzeria_crud_mvc.Models.DataBaseModels.Ingredient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IngredientPizza", b =>
                {
                    b.HasOne("la_mia_pizzeria_crud_mvc.Models.DataBaseModels.Ingredient", null)
                        .WithMany()
                        .HasForeignKey("IngredientsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("la_mia_pizzeria_crud_mvc.Models.DataBaseModels.Pizza", null)
                        .WithMany()
